...
sudo apt install -y vim-gtk blueman arandr i3 kitty xclip pavucontrol
sudo apt install -y libdvdnav4 gstreamer1.0-plugins-bad gstreamer1.0-plugins-ugly libdvd-pkg
